...
contract ProposalHelpers is PollHelpers {
    ...
    console.log("Proposal description:", proposals[_pollId][_proposalId].description);
    ...
    function recordMetaVote(uint256 _pollId, uint256 _proposalId, address voter) external {
        ...
        console.log("Voter has voted:", hasVoted(_pollId));
        ...
        public
    {
     ...
     /**
     * @notice Checks if a meta-vote has been recorded for a given voter, poll, and proposal.
     * @param _pollId The ID of the poll.
     * @param _proposalId The ID of the proposal.
     * @param voter The address of the voter.
     * @return `true` if the meta-vote is recorded, otherwise `false`.
     */
    function isMetaVoteRecorded(uint256 _pollId, uint256 _proposalId, address voter) external view returns (bool) {
        return userVotes[_pollId][voter][_proposalId] != 0;
    }
    ...
    function controlProposalEndDate(uint256 _pollId) internal view {
        console.log("Proposal phase end date:", polls[_pollId].details.proposalEndDate);
